...
if (isset($_POST['upload'])) {
    ...
    $folder = "./upload/" . $new_name;
    $img_name = $new_name;

	$sql = "INSERT INTO userimage (firstname,username,filename) VALUES ('{$logfname}','{$loguname}','$img_name')";

	mysqli_query($conn, $sql);

	if (move_uploaded_file($tempname, $folder)) {
		echo "<h3> Image uploaded successfully!</h3>";
    header("Location:{$hostname}/viewuserimage.php?loguname={$loguname}&logfname={$logfname}");
	} else {
                  ...
                  <div class="section text-center">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                      ...
                      else
                      {
                        ...
                        <div class="form-group ">
                        <button class="btn mt-4" type="submit" name="upload" id="upload">UPLOAD</button>
			            </div>
